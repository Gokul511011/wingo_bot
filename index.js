...
app.get('/', (req, res) => res.send('WinGo 30S 60-Run Non-Stop Engine Active!'));
...
// Pattern Engine (Anti Level-7 & Trend Flip)
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                console.error("Retrying API connection...");
            }
        }
        ...
        if (lastPredictedPeriod && lastPredictedPeriod === actualPeriod) {
            ...
            // 60 Predictions முடிந்தவுடன் அறிக்கை அனுப்பும் பகுதி
        ...
        if (nextPeriod !== lastSentPeriod) {
            ...
            console.log("[RUNNING] Period: " + nextPeriod + " (" + predictionCount + "/60)");
        }
    } catch (error) {
